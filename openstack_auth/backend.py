...
from .utils import get_realm, get_tenant_name
from swiftclient.contrib.federated.federated import federatedAuthentication
...
class KeystoneBackend(object):
    ...
    def authenticate(self, request=None, username=None, password=None,
                     user_domain_name=None, auth_url=None, external_auth_service=None):
